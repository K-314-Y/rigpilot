...
_ALLOWED: dict[WorkflowState, set[WorkflowState]] = {
    ...
    WorkflowState.ANALYZING: {WorkflowState.PROBING, WorkflowState.VALIDATING, WorkflowState.REPAIRING, WorkflowState.NEEDS_HUMAN_REVIEW, WorkflowState.FAILED},
    WorkflowState.PROBING: {WorkflowState.CAPTURING, WorkflowState.RESTORING, WorkflowState.NEEDS_HUMAN_REVIEW, WorkflowState.FAILED},
    WorkflowState.CAPTURING: {WorkflowState.PROBING, WorkflowState.RESTORING, WorkflowState.NEEDS_HUMAN_REVIEW, WorkflowState.FAILED},
    WorkflowState.RESTORING: {WorkflowState.VALIDATING, WorkflowState.NEEDS_HUMAN_REVIEW, WorkflowState.FAILED},
    WorkflowState.GENERATING: {WorkflowState.VALIDATING, WorkflowState.REPAIRING, WorkflowState.FAILED},
    WorkflowState.VALIDATING: {WorkflowState.CONNECTING, WorkflowState.ANALYZING, WorkflowState.FINAL_REVIEW, WorkflowState.NEEDS_HUMAN_REVIEW, WorkflowState.FAILED},
    WorkflowState.REPAIRING: {WorkflowState.ROLLING_BACK, WorkflowState.NEEDS_HUMAN_REVIEW, WorkflowState.FAILED},
    WorkflowState.ROLLING_BACK: {WorkflowState.VALIDATING, WorkflowState.NEEDS_HUMAN_REVIEW, WorkflowState.FAILED},
